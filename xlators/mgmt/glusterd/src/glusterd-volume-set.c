...
struct volopt_map_entry glusterd_volopt_map[] = {
	...
	{ .key         = "performance.prefetch-page-count",
	  .voltype     = "performance/io-cache",
          .option      = "prefetch-page-count",
          .op_version  = 1,
          .flags       = OPT_FLAG_CLIENT_OPT
	},
	{ .key         = "performance.ioc-multistreams",
	  .voltype     = "performance/io-cache",
          .option      = "ioc-multistreams",
          .type        = NO_DOC,
	  .op_version  = 1,
        },
	...
	{ .key         = "features.encryption",
	  ...
	  .flags       = OPT_FLAG_CLIENT_OPT | OPT_FLAG_XLATOR_OPT
        ...
        { .key         = "performance.nfs.readdir-preload",
          .voltype     = "performance/readdir-preload",
          .option      = "!nfsperf",
          .value       = "on",
          .op_version  = 3,
          .description = "enable/disable readdir-preload translator in the volume.",
          .flags       = OPT_FLAG_CLIENT_OPT | OPT_FLAG_XLATOR_OPT
        },
        { .key         = "performance.nfs.dirstat-cache",
          .voltype     = "performance/dirstat-cache",
          .option      = "!nfsperf",
          .value       = "on",
          .op_version  = 3,
          .description = "enable/disable dirstat-cache translator in the volume.",
          .flags       = OPT_FLAG_CLIENT_OPT | OPT_FLAG_XLATOR_OPT
        },
	...
	/* Feature translators */
        ...
        /* readdir-preload translator options */
        { .key         = "readdir-preload.rdp-special-client",
          .voltype     = "performance/readdir-preload",
          .type        = NO_DOC,
          .op_version  = 3
        },
        { .key         = "readdir-preload.rdp-stream-count",
          .voltype     = "performance/readdir-preload",
          .type        = NO_DOC,
          .op_version  = 3
        },
        { .key         = "readdir-preload.rdp-low-wmark",
          .voltype     = "performance/readdir-preload",
          .type        = NO_DOC,
          .op_version  = 3
        },
        { .key         = "readdir-preload.rdp-high-wmark",
          .voltype     = "performance/readdir-preload",
          .type        = NO_DOC,
          .op_version  = 3
        },
        ...
        { .key         = "readdir-preload.rdp-cache-wmark",
          .voltype     = "performance/readdir-preload",
          .type        = NO_DOC,
          .op_version  = 3
        },
        { .key         = "readdir-preload.rdp-cache-limit",
          .voltype     = "performance/readdir-preload",
          .type        = NO_DOC,
          .op_version  = 3
        },

        /* dirstat-cache translator options */
        { .key         = "dirstat-cache.dsc-special-client",
          .voltype     = "performance/dirstat-cache",
          .type        = NO_DOC,
          .op_version  = 3
        },
        { .key         = "dirstat-cache.dsc-cache-timeout",
          .voltype     = "performance/dirstat-cache",
          .type        = NO_DOC,
          .op_version  = 3
        },
