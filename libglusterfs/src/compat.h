...
#define atomic_add(var,v)       atomic_add_and_fetch(var,v)
#define atomic_sub(var,v)       atomic_sub_and_fetch(var,v)
#define atomic_inc(var)         atomic_inc_and_fetch(var)
#define atomic_dec(var)         atomic_dec_and_fetch(var)
#define atomic_get(var)         atomic_add_and_fetch(var, 0)
#define atomic_init(var, n)     ({var = 0; __sync_synchronize();})
#define atomic_compare_exchange(ptr, exp, desired) __atomic_compare_exchange_n(ptr, exp, desired, 0, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST)
#else
