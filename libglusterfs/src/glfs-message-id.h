...
#define GLFS_MSGID_COMP_READDIR_PRELOAD           GLFS_MSGID_COMP_READDIR_AHEAD_END
#define GLFS_MSGID_COMP_READDIR_PRELOAD_END       (GLFS_MSGID_COMP_READDIR_PRELOAD+\
                                                GLFS_MSGID_SEGMENT)

#define GLFS_MSGID_COMP_SYMLINK_CACHE           \
GLFS_MSGID_COMP_READDIR_PRELOAD_END
